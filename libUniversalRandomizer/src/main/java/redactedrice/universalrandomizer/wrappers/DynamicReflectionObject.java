...
public class DynamicReflectionObject<T> {
    private T obj;
    private Map<String, Object> variables;

    protected DynamicReflectionObject(T obj) {
        this.obj = obj;
    }

    public static <T2> DynamicReflectionObject<T2> create(T2 obj) {
        if (obj == null) {
            return null;
        }
    ...
    public void setDynamicVar(String name, Object val) {
        variables.put(name, val);
    }

    public Object getDynamicVar(String name) {
    ...
    public Object setField(String pathToSetterOrField, Object value)
        ...
        if (lastPath.endsWith("()")) {
            ...
            // This is falsely flagged by sonarlint as an accessibility bypass - getField only
            // returns
    ...
    private Method getMethodByName(Object obj, String methodName, Object... params)
    ...
    private Object getFromMethodOrField(Object owningObj, String methodOrField)
        ...
        if (methodOrField.endsWith("()")) {
            return getMethodByName(owningObj,
                    methodOrField.substring(0, methodOrField.length() - 2)).invoke(owningObj);
        } else {
